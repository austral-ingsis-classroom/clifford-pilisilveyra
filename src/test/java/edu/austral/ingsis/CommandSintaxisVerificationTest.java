...
class CommandSintaxisVerificationTest {

    @Test
    void testCdCommandCorrect() {
        CommandCreator creator = new CdCommandCreator();
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("cd", List.of("folder"));
    ...
    void testLsCommandCorrectOrderedAsc() {
        CommandCreator creator = new LsCommandCreator();
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("ls", List.of("--ord=asc"));
        assertDoesNotThrow(() -> creator.create(parseCommand));
    }
    ...
    void testLsCommandIncorrect() {
        CommandCreator creator = new LsCommandCreator();
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("ls", List.of("--sort=name"));
        assertThrows(IllegalArgumentException.class, () -> creator.create(parseCommand));
    }
    ...
    void testMkdirCommandCorrect() {
        ...
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("mkdir", List.of("newfolder"));
        assertDoesNotThrow(() -> creator.create(parseCommand));
    }
    ...
    void testRmCommandCorrectUnrecursive() {
        ...
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("rm", List.of("file.txt"));
        assertDoesNotThrow(() -> creator.create(parseCommand));
    }
    ...
    void testRmCommandCorrectRecursive() {
        CommandCreator creator = new RmCommandCreator();
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("rm", List.of("--recursive", "folder"));
        assertDoesNotThrow(() -> creator.create(parseCommand));
    }
    ...
    void testRmCommandIncorrect() {
        CommandCreator creator = new RmCommandCreator();
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("rm", List.of("folder", "--recursive"));
        assertThrows(IllegalArgumentException.class, () -> creator.create(parseCommand));
    }
    ...
    void testTouchCommandCorrect() {
        ...
        CommandParser.ParseCommand parseCommand =
                new CommandParser.ParseCommand("touch", List.of("file.txt"));
        assertDoesNotThrow(() -> creator.create(parseCommand));
    }
